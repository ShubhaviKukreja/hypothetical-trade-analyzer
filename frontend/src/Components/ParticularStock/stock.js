...
import { Button, Result, Layout, theme, Radio, Space } from 'antd';
            ...
            <Row>
                <Col sm={3}> 
                    <Nav variant="pills" className="flex-column">
                        ...
                        <Nav.Item>
                            <Nav.Link eventKey="third">Stock Information</Nav.Link>
                        </Nav.Item>
                    </Nav>
                </Col>
                <Col sm={9}>
                    <Tab.Content>
                        ...
                        <Tab.Pane eventKey="second">
                            ...
                            <form onSubmit={handleSubmit2}>
                                ...
                                <Button type="primary" disabled={loading}>Submit</Button>
                            </form>
